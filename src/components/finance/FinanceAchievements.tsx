...
import { BarChart3, PiggyBank, DollarSign, ArrowUpDown, Flag, Crown, CircleCheck, TrendingUp, Bookmark, Gem } from "lucide-react";

interface FinanceAchievementsProps {
  unlockAchievement: (achievementId: string) => Promise<void>;
}

const FinanceAchievements: React.FC<FinanceAchievementsProps> = ({ 
  unlockAchievement 
}) => {
